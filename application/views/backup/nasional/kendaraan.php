...
$(document).ready(function() {
    var t = $('#dataTable').DataTable({
        ...
        "processing": true,
        ajax: {
            url: base_url + 'nasional/kendaraan/get',
        ...
        "columns": [
            ...
            { "data": "thn_produksi" },            
            { "data": "merk_tipe" },
            { "data": "no_rangka", "className": "none" },
            { "data": "no_stnk", "className": "none" },
            { "data": "masa_stnk", "className": "none" },            
            { "data": "no_kir", "className": "none" },
            { "data": "masa_kir", "className": "none" },
            { "data": "bbm", "className": "none" },
            { 
                "render": function (data, type, JsonResultRow, meta) {
