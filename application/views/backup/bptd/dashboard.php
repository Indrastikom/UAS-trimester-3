        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-primary text-white mb-4">
                <div class="card-body">
                    ...
                    Jumlah Cabang  = <span class="badge badge-warning badge-pill" id="jml_cabang"></span>
                </div>            
            </div>
        </div>
        <div class="col-xl-3 col-md-6">
            <div class="card bg-warning text-white mb-4">
                <div class="card-body">
                    ...
                    Total Trayek = <span class="badge badge-primary badge-pill" id="jml_trayek"></span>
                </div>            
            </div>
        </div>
        <div class="col-xl-3 col-md-6">
            <div class="card bg-success text-white mb-4">
                <div class="card-body">
                    ...
                    Total Kendaraan = <span class="badge badge-warning badge-pill" id="jml_kendaraan"></span>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6">
            <div class="card bg-danger text-white mb-4">
                <div class="card-body">
                    ...
                    Total Pengemudi = <span class="badge badge-warning badge-pill" id="jml_pengemudi"></span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table-sm table-hover table-bordered ng2-nowrap list-cabang" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Nama Cabang</th>
...
function getCabang(){
    $.ajax({
        url: base_url + 'bptd/dash/getCabang',
        type: 'GET',
        dataType: 'JSON',
        contentType: false,
        processData: false,
