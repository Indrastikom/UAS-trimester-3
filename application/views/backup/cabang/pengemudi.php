...
<?php $this->load->view('cabang/driver_form');?>
...
$(document).ready(function() {
    var t = $('#dataTable').DataTable({
        ...
        ajax: {
            url: base_url + 'cabang/pengemudi/getBYkontrak/'+cokies_kontrak_id,
...
function getPengemudiBYid(id){
    $.ajax({
        url: base_url + 'cabang/pengemudi/get/'+id,
        type: 'GET',
        dataType: 'JSON',
        contentType: false,
        processData: false,        
...
function simpan(){
    ...
    var urlData = base_url + 'cabang/pengemudi/add';
    $.ajax({
        type: 'POST',
        url: urlData,
        dataType: 'JSON',
...
function update(id){
    var formData = new FormData($('#form-simpan form')[0]);
    var urlData = base_url + 'cabang/pengemudi/edit/'+id;
    $.ajax({
        type: 'POST',
        url: urlData,
        dataType: 'JSON',
...
function hapus(id){
    var urlData = base_url + 'cabang/pengemudi/hapus/'+id;
    $.ajax({
        type: 'POST',
        url: urlData,
        dataType: 'JSON',
